...
% Resource.Parameters.fakeScanhead = 1;%~ 不连接探头用
...
Resource.RcvBuffer(1).numFrames = 60;       %~ 采样帧率2000 frames/s。总共采集（na*numFrames）帧的数据。na帧组成一个大数据帧。numFrames表示大帧的数目。
...
save('MatFiles/L11-5vFlash_Trigger_Dual_30s_1000');
return
