...
Resource.RcvBuffer(1).numFrames = 160;       %~ 采样帧率800 frames/s。总共采集（na*numFrames）帧的数据。na帧组成一个大数据帧。numFrames表示大帧的数目。
...
SeqControl(2).argument = 1250;  % 1250us %~ 采集相邻2帧数据的时间间隔
...
save('MatFiles/L11-5vFlash_Trigger_800hz_20s');
return
