...
Trans.maxHighVoltage = 40;  % much restricted than specified on data sheet
...
Resource.RcvBuffer(1).numFrames = 1000;       % 100 frames used for RF cineloop.
