...
Resource.RcvBuffer(1).numFrames = 1000;       % 1000 frames used for RF cineloop.
...
SeqControl(2).argument = 500;  % 500us
...
save('MatFiles/L11-5vFlash_testTrigger');
return
