...
typedef struct fdGlove fdGlove;
...
void  fdResetCalibrationAll(fdGlove *pFG);
...
void	fdSetCallback(fdGlove *pFG,void *pFunc, void *param);
void	fdRemoveCallback(fdGlove *pFG);
...
bool	fdGetSerialNumber(fdGlove *pFG, char *pData);